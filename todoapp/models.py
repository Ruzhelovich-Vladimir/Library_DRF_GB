...
class Project(models.Model):
    ...
    authors = models.ManyToManyField(Author, verbose_name='участники проекта')
...
class ToDo(models.Model):
    ...
    author = models.ForeignKey(Author, verbose_name='пользователь', on_delete=models.PROTECT)
